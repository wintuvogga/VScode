...
/**This command can be used to open a Bluetooth Classic connection to a remote device. 
...
/**This command can used to set BT121 in "BT RF SIG mode" which is meant for 
